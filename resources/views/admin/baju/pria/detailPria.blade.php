        ...
        <div class="container pb-5">
            <div class="row">
                <div class="col-lg-5 mt-5">
                    <div class="card mb-3">
                        <img class="card-img img-fluid" src="/image/items/{{ $detail_bajuPria->image }}"  alt="Card image cap" id="product-detail">
                    </div>
                    <div class="row">
                        ...
                        <div id="multi-item-example" class="col-12 slide carousel-multi-item carousel-related-product" data-bs-ride="carousel">
                            ...
                            <div class="carousel-inner product-links-wap" role="listbox">
                                ...
                                @if ($detail_bajuPria->image && $detail_bajuPria->image2 && $detail_bajuPria->image3)
                                    <div class="carousel-item active">
                                        <div class="row">
                                            <div class="col-4">
                                                <a href="#">
                                                    <img class="card-img img-fluid" src="/image/items/{{ $detail_bajuPria->image }}" alt="Product Image 1">
                                                </a>
                                            </div>
                                            <div class="col-4">
                                                <a href="#">
                                                    <img class="card-img img-fluid" src="/image/items/{{ $detail_bajuPria->image2 }}" alt="Product Image 2">
                                                </a>
                                            </div>
                                            <div class="col-4">
                                                <a href="#">
                                                    <img class="card-img img-fluid" src="/image/items/{{ $detail_bajuPria->image3 }}" alt="Product Image 3">
                                                </a>
                                            </div>
                                        </div>
                                    </div>
                                @elseif ($detail_bajuPria->image && !$detail_bajuPria->image2 && !$detail_bajuPria->image3)
                                    <div class="carousel-item active">
                                        <div class="row">
                                            <div class="col-4">
                                                <a href="#">
                ...
                <div class="col-lg-7 mt-5">
                    <div class="card">
                        <div class="card-body">
                            <h1 class="h2">{{ $detail_bajuPria->nama }}</h1>
                            <p class="h3 py-2">Rp{{ $detail_bajuPria->harga }}</p>
                            <p class="py-2">
                            ...
                            <ul class="list-inline">
                                ...
                                <li class="list-inline-item">
                                    <p class="text-muted"><strong>{{ $detail_bajuPria->brand }}</strong></p>
                                </li>
                            </ul>

                            <h6>Deskripsi Produk:</h6>
                            <p>{{ $detail_bajuPria->deskripsi }}</p>
                            <ul class="list-inline">
                                <li class="list-inline-item">
                            ...
                            <form action="/cart/{{ $detail_bajuPria->id }}/add" method="post">
                                @csrf
                                @method('put')

                                <input type="hidden" name="nama" value="{{ $detail_bajuPria->nama }}">
                                <div class="row">
                                    <div class="col-auto">
                                        <input type="hidden" name="image" value="{{ $detail_bajuPria->image }}">
                                    </div>
                                    <div class="col-auto">
                                ...
                                <div class="row pb-3">
                                    <input type="hidden" name="harga" value="{{ $detail_bajuPria->harga }}">
                            ...
                            <div class="row pb-3">
                                <div class="col d-grid">
                                    <form action="/checkout/payment/detail/{{ $detail_bajuPria->id }}" method="post">
                                        @csrf
                                        <input type="hidden" name="nama" value="{{ $detail_bajuPria->nama }}">
                                        <input type="hidden" name="harga" value="{{ $detail_bajuPria->harga }}">
                        ...
                        <div class="card rounded-0">
                            ...
                            <div class="card-img-overlay rounded-0 product-overlay d-flex align-items-center justify-content-center">
                                <ul class="list-unstyled">
                                    <li><a class="btn btn-primary text-white mt-2" href="/baju/mens/{{ $cloth->id }}/detail"><i class="far fa-eye"></i></a></li>
                                </ul>
                            </div>
                        </div>
                        <div class="card-body">
                            <a href="/baju/mens/{{ $cloth->id }}/detail" class="h3 text-decoration-none">{{ $cloth->nama }}</a>
