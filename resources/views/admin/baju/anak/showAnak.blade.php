                    ...
                    <div class="col-sm-4" data-aos="fade" data-aos-delay="100">
                        <div class="item mb-4">
                            <div class="block-4 text-center">
                                ...
                                @can('admin')
                                    <a href="/baju/kids/{{ $cloth->id }}/update" class="btn btn-dark card-link mx-4">Edit</a>
                                    <a href="/baju/kids/{{ $cloth->id }}/delete" class="delete btn btn-danger card-link" data-id="{{ $cloth->id }}">Hapus</a>
                                @endcan
        ...
        $('.delete').click(function (e) {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    window.location = '/baju/kids/'+clothId+'/delete'
                    Swal.fire(
                    'Sukses Terhapus!',
                    'Baju Telah Di Hapus',
                    'BERHASIL'
