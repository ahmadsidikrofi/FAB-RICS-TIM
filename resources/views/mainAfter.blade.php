...
{{--  --}}
                    ...
                    <div class="row align-items-start align-items-md-center justify-content-end">
                        <div class="col-md-5 text-center text-md-left pt-5 pt-md-0">
                            ...
                            <div class="intro-text text-center text-md-left">
                                <p class="mb-4">Tampil Menarik dan Percaya Diri dengan Baju Terbaik dari Kami dan Pilih Baju yang Sesuai dengan Kebutuhan dan Gaya Hidupmu </p>
                                <a href="/catalogue">
                                    <div class="scene">
                                        <div class="cube">
                                            <span class="side top">NOW!</span>
                                            <span class="side front">Explore</span>
                                        </div>
                                    </div>
                                </a>
                                    {{-- <a href="/catalogue" class="btn btn-sm btn-primary">Explore New Arrival</a> --}}
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <script>
        @if (Session::has('berhasilLogin'))
            toastr.success('Selamat Datang di Fab-Rics')
        @endif
    </script>
